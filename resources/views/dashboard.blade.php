						...
						<div class="col-xl-3 col-md-6 col-6">
							<div class="box">
								<div class="box-body text-center">
									...
									<p class="text-fade mt-15 mb-5">User</p>
						...
						<div class="col-xl-3 col-md-6 col-6">
							<div class="box">
								<div class="box-body text-center">
									...
									<p class="text-fade mt-15 mb-5">Product</p>
						...
						<div class="col-xl-3 col-md-6 col-6">
							<div class="box">
								<div class="box-body text-center">
									...
									<p class="text-fade mt-15 mb-5">Role</p>
									<h2 class="mt-0">{{$total_role}}</h2>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-6">
							<div class="box">
								<div class="box-body text-center">
									...
									<p class="text-fade mt-15 mb-5">Order</p>
                ...
                <div class="col-xl-3 col-md-6 col-6">
                    <div class="box">
                        <div class="box-body text-center">
                            ...
                            <p class="text-fade mt-15 mb-5">Transaction</p>
								...
								<div class="box-body">
									<div class="inner-user-div3">
										...
										<div class="d-flex align-items-center">
											...
											<div class="dropdown">
												<a class="px-10 pt-5" href="#" data-bs-toggle="dropdown"><i class="ti-more-alt"></i></a>.0
												<div class="dropdown-menu dropdown-menu-end">
												  <a class="dropdown-item flexbox" href="#">
													<span>Inbox</span>
													<span class="badge badge-pill badge-info">5</span>
