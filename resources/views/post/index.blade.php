                    ...
                    <table id="example5" class="table table-bordered table-striped" style="width:100%">
                        ...
                        <div class="container">
                         <div class="alert alert-success alert-dismissible">
                             ...
                             <strong></strong> {{session()->get('message')}}</div>
                        </div>@endif

                    <div class="col-12..text-right" align="right">
                      <a href="{{route('post.create')}}">
                         <button type="submit" class="btn btn-primary">Add Post</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
								...
								<td>{{$d->title}}</td>
                                <td>{!!$d->description!!}</td>
                                <td>{{$d->featured == 1 ? 'Yes' : 'No'}}</td>

                                <td>{{$d->status == 1 ? 'Active' : 'Inactive'}}</td>
                                <td>{{@$d->category->name}}</td>
<td>
                                    <img src="{{ asset('uploads/products/'.$d->profile_image) }}" width="70px" height="70px" alt="Image">
                                </td>
                                <td><a href="{{route('post.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('post.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
