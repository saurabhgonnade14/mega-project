                ...
                <div class="table-responsive">
                    ...
                    <div class="col-12..text-right" align="right">
                      <a href="{{route('category.create')}}">
                         <button type="submit" class="btn btn-primary">Add Category</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
								...
								<td>{{$d->name}}</td>
                                <td>{{$d->status}}</td>
                                <td><a href="{{route('category.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('category.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
