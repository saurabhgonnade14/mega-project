								...
								<div class="row">
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  {{-- <input type="text" class="form-control" placeholder="user" name="user" value="{{$data->user->name}}" > --}}
								  ...
								  <div class="col-md-6">
									<div class="form-group">
                                      ...
                                      <select class="form-select" name="product_id">
                                        <option value="{{$data->products->id}}">{{$data->products->product}}</option>
									  ...
									  {{-- <input type="text" class="form-control" placeholder="product" name="product" value="{{@$data->product->product}}"> --}}
									</div>
								  </div>
								</div>
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="number" class="form-control" placeholder="tax" name="tax" value="{{$data->tax}}">
									</div>
								  </div>
                                  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">delivery charges</label>
									  <input type="number" class="form-control" placeholder="delivery charges" name="delivery_charges" value="{{$data->delivery_charges}}">
									</div>
								  </div>
                                  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">total</label>
									  <input type="number" class="form-control" placeholder="total" name="total" value="{{$data->total}}">
									</div>
								  </div>
                                  <div class="col-md-6">
									<div class="form-group">
                                  ...
                                  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="number" class="form-control" placeholder="tracking number" name="tracking_number" value="{{$data->tracking_number}}">
									</div>
								  </div>
