                   ...
                   <div class="container">
                    ...
                    <div class="col-12..text-right" align="right">
                      <a href="{{route('order.create')}}">
                         <button type="submit" class="btn btn-primary">Add Order</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
                                ...
                                <td><a href="{{route('order.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('order.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
