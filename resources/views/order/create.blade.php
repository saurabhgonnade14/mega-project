							...
							<div class="box-body">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="number" class="form-control" placeholder="delivery charges" name="delivery_charges">
									</div>
								</div>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="number" class="form-control" placeholder="tracking number" name="tracking_number">
									</div>
								</div>
