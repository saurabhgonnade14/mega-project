                ...
                <div class="table-responsive">
                    ...
                    <div class="col-12..text-right" align="right">
                      <a href="{{route('role.create')}}">
                         <button type="submit" class="btn btn-primary">Add Role</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
								...
								<td>{{$d->name}}</td>
                                <td>{{$d->slug}}</td>
                                <td><a href="{{route('role.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('role.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
