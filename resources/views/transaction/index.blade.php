                ...
                <div class="table-responsive">
                    ...
                    <div class="col-12..text-right" align="right">
                      <a href="{{route('transaction.create')}}">
                         <button type="submit" class="btn btn-primary">Add Transaction</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
                                ...
                                <td>{{$d->mode}}</td>
                                <td>{{$d->type}}</td>
                                <td><a href="{{route('transaction.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('transaction.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
