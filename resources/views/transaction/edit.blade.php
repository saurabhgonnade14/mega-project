								...
								<div class="row">
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="Order Id" name="Order_Id" value="{{$data->order_id}}">
									</div>
								  </div>
								  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">mode</label>
									  <input type="text" class="form-control" placeholder="mode" name="mode" value="{{$data->mode}}">
									</div>
								  </div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="type" name="type" value="{{$data->type}}">
									</div>
								  </div>
