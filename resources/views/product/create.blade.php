							...
							<div class="box-body">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                      ...
                                      <select class="form-select" name="secret_id">
									  ...
									  {{-- <input type="text" class="form-control" placeholder="secret id" name="secret_id"> --}}
									</div>
								  </div>
                                ...
                                {{-- <form action="/action_page.php">
                                    <input type="file" id="myfile" name="product_name">
                                </form> --}}
