						...
						<form  action="{{route('product.update',$data->id)}}" Method="post" enctype="multipart/form-data">
							...
							<div class="box-body">
								...
								<div class="row">
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="product" name="product" value="{{$data->product}}">
									</div>
								  </div>
								  <div class="col-md-6">
									<div class="form-group">
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="discount" name="discount" value="{{$data->discount}}">
									</div>
								  </div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="number" class="form-control" placeholder="secret id" name="secret_id" value="{{$data->secret_id}}">
									</div>
								  </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" name="profile_image" class="form-control" value="{{$data->file}}">
                                </div>
