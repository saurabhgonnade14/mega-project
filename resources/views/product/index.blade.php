                      ...
                      <a href="{{route('product.create')}}">
                         <button type="submit" class="btn btn-primary">Add Product</button></a>
							...
							<tr>
                                ...
                                <td><a href="{{route('product.edit',$d->id)}}"><button class="btn btn-warning">edit</button></a></td>
                                <td><a href="{{route('product.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
