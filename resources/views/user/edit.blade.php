	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Edit Form Elements</h4>
				...
				<div class="col-lg-6 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Edit Form</h4>
						</div>
						<!-- /.box-header -->
						<form  action="{{route('user.update',$data->id)}}" Method="post">
                            @csrf
							<div class="box-body">
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Edit Info</h4>
								<hr class="my-15">
								<div class="row">
								  <div class="col-md-6">
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="contact number" name="contact number" value="{{$data->contact_number}}">
									</div>
								  </div>
								</div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" placeholder="pincode" name="pin" value="{{$data->pin}}">
									</div>
								</div>
