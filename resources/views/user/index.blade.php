                ...
                <div class="table-responsive">
                    ...
                    <div class="col-12..text-right" align="right">
                      <a href="{{route('user.create')}}">
                         <button type="submit" class="btn btn-primary">Add User</button></a>
                    </div><br><br>
								<thead>
							...
							<tr>
                                ...
                                <td>{{$d->address}}</td>
                                <td>{{$d->pin}}</td>
                                <td>{{$d->country->name ?? 'N/A'}}</td>
                                <td>{{@$d->state->name}}</td>
                                <td>{{@$d->city->name}}</td>
                                <td><a href="{{route('user.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('user.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
