                      ...
                      <a href="{{route('secret.create')}}">
                         <button type="submit" class="btn btn-primary">Add User</button></a>
							...
							<tr>
								<td>{{$d->id}}</td>
								<td>{{$d->name}}</td>
                                <td><a href="{{route('secret.edit',$d->id)}}"><button class="btn btn-success">edit</button></a></td>
                                <td><a href="{{route('secret.delete',$d->id)}}"><button class="btn btn-danger">delete</button></a></td>
