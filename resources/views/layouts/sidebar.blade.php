    ...
    <section class="sidebar position-relative">
		<div class="help-bt">
			<a href="tel:108" class="d-flex align-items-center">
				...
				<h4 class="mb-0">Hello<br>help</h4>
			</a>
		</div>
	  	<div class="multinav">
		  <div class="multinav-scroll" style="height: 100%;">
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					<li><a href="{{route('user.create')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add user</a></li>
					<li><a href="{{route('user.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage user</a></li>
				  </ul>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="{{route('product.create')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add user</a></li>
                      <li><a href="{{route('product.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage user</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="{{route('role.create')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add role</a></li>
                      <li><a href="{{route('role.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage role</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="{{route('order.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage order</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="{{route('transaction.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage transaction</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('secret.create')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add secret</a></li>
                      <li><a href="{{route('secret.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage secret</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="{{route('category.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage category</a></li>
                    </ul>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="{{route('post.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage post</a></li>
                    </ul>
                  ...
                  <p>
                      <div class="container">
                          <a href="{{route('logout')}}" class="btn btn-info btn-primary">
                            <span class="glyphicon glyphicon-log-out" style="font-size: 30px"></span>Log out</a>
                      </div>
                  </p>
